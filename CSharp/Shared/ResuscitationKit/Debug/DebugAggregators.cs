...
namespace JovianRadiationRework
{
  ...
  public class DebugAggregator<T1, T2, T3> : DebugGate<T1, T2, T3>
  {
  ...
  public class DebugAggregator<T1, T2, T3, T4> : DebugGate<T1, T2, T3, T4>
  {
  ...
  public class DebugAggregator<T1, T2, T3, T4, T5> : DebugGate<T1, T2, T3, T4, T5>
  {
