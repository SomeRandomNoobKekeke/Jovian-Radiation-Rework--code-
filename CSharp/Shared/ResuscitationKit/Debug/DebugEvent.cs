...
namespace ResuscitationKit
{
  ...
  public class DebugEvent : DebugEventCore
  {
  ...
  public class DebugEvent<T1> : DebugEventCore
  {
  ...
  public class DebugEvent<T1, T2> : DebugEventCore
  {
  ...
  public class DebugEvent<T1, T2, T3> : DebugEventCore
  {
  ...
  public class DebugEvent<T1, T2, T3, T4> : DebugEventCore
  {
  ...
  public class DebugEvent<T1, T2, T3, T4, T5> : DebugEventCore
  {
